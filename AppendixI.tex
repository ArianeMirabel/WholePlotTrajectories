...
\textbf{Figure A3}: Trajectories of the difference to the 1989
...
\textbf{Figure A5}: Summarizing plots of the functional PCA analysis
...
\textbf{Figure A6}: Trajectories of the functional redundancy over 30
years after disturbance. Trajectories correspond to the median (solid
line) and 0.025 and 0.975 percentile (gray envelope) observed after 50
...
\section{\texorpdfstring{\textbf{Figure A2}: Proportion of seed mass
classes along
time}{Figure A2: Proportion of seed mass classes along time}}\label{figure-a2-proportion-of-seed-mass-classes-along-time}
...
\section{\texorpdfstring{\textbf{Figure A3}: Richness, Shannon and
Simpson taxonomic diversity
trajectories}{Figure A3: Richness, Shannon and Simpson taxonomic diversity trajectories}}\label{figure-a3-richness-shannon-and-simpson-taxonomic-diversity-trajectories}
...
\section{\texorpdfstring{\textbf{Figure A5}: Functional
PCA}{Figure A5: Functional PCA}}\label{figure-a5-functional-pca}
...
\section{\texorpdfstring{\textbf{Figure A6}: Overall functional
redundancy}{Figure A6: Overall functional redundancy}}\label{figure-a6-overall-functional-redundancy}
