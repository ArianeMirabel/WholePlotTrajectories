...
\textbf{Figure A2}: Trajectories of the distance to initial condition of
the 30 sampled years in the two-dimensional space from the NMDS of v
taxonomic composition at genus level and (ref:Boldb) functional
composition. Distance are abundance-based Bary-Curtis metric. Line
colors represent the disturbance treatment (green for control, blue for
T1,orange for T2 and red for T3). The 0.025 and 0.975 percentile
correspond to the variance observed for 50 iteration of the taxonomic
uncertainty propagation and functional trait filling processes.
...
\textbf{Figure A4}: Trajectories of the Rao functional diversity over 30
...
\section{\texorpdfstring{\textbf{Figure A2}: Dissimilarity to initial
inventory of plots taxonomic and functional
composition}{Figure A2: Dissimilarity to initial inventory of plots taxonomic and functional composition}}\label{figure-a2-dissimilarity-to-initial-inventory-of-plots-taxonomic-and-functional-composition}

\begin{figure*}

{\centering \includegraphics[width=0.8\linewidth]{AppendixI_files/figure-latex/NMDSdivergence-1} 
...
\section{\texorpdfstring{\textbf{Figure A4}: Rao diversity trajectories
with all plots
display}{Figure A4: Rao diversity trajectories with all plots display}}\label{figure-a4-rao-diversity-trajectories-with-all-plots-display}
