...
\section{\texorpdfstring{\textbf{Figure A3}: Rao diversity trajectories
with all plots
display}{Figure A3: Rao diversity trajectories with all plots display}}\label{figure-a3-rao-diversity-trajectories-with-all-plots-display}
...
\section{\texorpdfstring{\textbf{Figure A4}: Functional
PCA}{Figure A4: Functional PCA}}\label{figure-a4-functional-pca}
...
\section{\texorpdfstring{\textbf{Figure A5}: Overall functional
redundancy}{Figure A5: Overall functional redundancy}}\label{figure-a5-overall-functional-redundancy}
