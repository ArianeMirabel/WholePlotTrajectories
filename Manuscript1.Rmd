...
The experiment corresponds to a network of twelve 6.25ha plots where three logging, thinning and fuelwood treatments on an intensity gradient. 
Disturbance treatments were attributed according to a randomized plot design with three replicate blocks of four plots. 
The logging correspond to averages of 10 trees removed per hectare with a diameter at 1.3 m height (DBH) above 50 cm for treatment 1 (T1), 32 trees/ha above 40 cm DBH for treatment 2 (T2) and 40 trees above 40 cm DBH for treatment 3 (T3). 
Treatments T2 and T3 included besides logging of 10trees/ha the thinning by poison girdling \ref{@Blanc2009}. 
...
***T2***            DBH ≥ 50 cm,            DBH ≥ 50 cm,                   40 cm ≤ DBH ≤ 50 cm
