...
Such deterministic selection is though to be driven by the trade-off between rapid growth and resources acquisition, therefore "acquisitive strategies" and slow growth with scarce resources [@Sheil2003].
...
The long-term survey of tropical forest plots after disturbance demonstrated a significant impact on stands composition and abundance distribution lasting for more than 30 years.
Disturbance induced environmental filters favoring acquisitive functional types and enhancing communities evenness.
Plots response was highly variable and might depend on its initial conditions.
...
> Recovery of the composition, probably not much external arrivals (seed mass characteristics as in storm regime [@Burslem2000] the recovery is probably due to the coexistence of species. Sometimes recovery is only due to resprouting and regrowth of species in place [@Zimmerman1994]
> Higher seed mass = more sensitive to fragmentation because of the dispersers ecology [@Cramer2007]
> Hubbell: identical species abundance repartition so the recruitment is random. This is the natural regime: we also proved that.The disturbance changes the natural disturbance regime?
...
> Composition can change the environmental recovery: resprouting and seedling dynamics are highly dependant of taxonomic composition [@Paciorek2000]
> The recovery dynamics largely depend on the past disturbance regime also [@Burselm2000]
