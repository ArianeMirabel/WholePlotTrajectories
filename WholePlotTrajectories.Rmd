...
*Taxonomic diversity* _ Trajectories of Richness, Shannon and Simpson taxonomic diversity were examined in relation to the 1994 inventories \autoref{Fig5}. 
...
The richness stabilized for all disturbed plots from 20 years after disturbance \autoref{Fig5}. 
The Shannon and Simpson diversity also stabilized 20 years after disturbance for T1 and T2 plots \autoref{Fig5} whereas for 2 out of 3 plots T3 the Shannon and Simpson diversity continued increasing until 30 years after disturbance, illustrating a significant increase in communities’ evenness.
...
Our study underlined the significant impact of disturbance on tropical forests communities but a contrasting response of taxonomic and functional diversity.
Specifically,  it unveiled the decoupling between trajectories of taxonomic evenness and their functional diversity and dominant characteristics.
This decoupling confirms the "vegetation quantity effect" suggesting that communities functional characteristics are determined by dominant species rather that subtle changes in biodiversity [@reftobefound]. This would result in a faster recovery of ecosystem processes rates than in communities ocmposition and diversity as it mas largely demonstrated for grasslands [@Tilman1997; @Mokany2008; @Mouillot2011 *in Lohbeck2015*] and recently proved for tropical forests [@Lohbeck2015].  
...
In line with the assumtions of the IDH our 30 years survey confirmed the significant increase of communities evenness and functional richness after disturbance.
As it was demonstrated for the conditions 10 years after disturbance [@Molino2001] the directional changes in communities composition reflected environmental filtering after disturbance which would support the IDH as demonstrated in [@Molino2001] rather than pure stochastic dynamics as suggested in [@Hubbell1998].
The trajectories shaping a unimodal response to disturbance suggested the recovery of communities initial state as it was already suggested by the previous studies from the same site 10 years [@Molino2001] and 20 years [@Baraloto2012a] after disturbance.
Only one plot displayed a still increasing Simpson diversity, and all plots showed a stabilization or a decrease of the composition distancing from 1989 inventories. 
This recovery corroborate previous post-disturbance dynamics observed in a Bornean rainforest [@Cannon1998] where at large scale the richness was preserved although it was diminished locally or in Solomon islands where stands demonstrated a fast recovery and identical composition [@Burselm2000].

Although recovery seemed on its way the trajectories revealed significant changes in the ecological rules shaping communities over the 30 years of survey.
Disturbance is thought to shift exclusive competition favoring competitive species to environmental filtering selecting acquisitive and disturbance resistant species [@TerSteege2001;@Flores2006;@Haddad2008]
...
In particular this is demonstrated by the evolution of seed mass classes proportions revealing a clear increase in small seeded and then large dispersive species.
Faster than for taxonomic composition and diversity though, functional characteristic returned to their initial values and the values observed for control plots.
This suggested some functional overlap in the pre-disturbance condition (*i.e* the usual tropical forests conditions). 
Such overlap and maybe functional versatility was already observed in highly diverse ecosystems [@Bellwood2006] and sugegsted as one mechanisms for high diversity maintenance.
Decoupled taxonomic and functional trajectories questions to what extent communities recovery is completed: ecosystem functioning might be quickly recoverd, and taxonomic composition following suit although along for much longer, but the resilience of the community itself might be altered as functional overlap themselves would be lost.
Along with probably other environmental modifications (like soils nutrient cycling and compaction [@Olander2005]) with alteration of communities resilience makes us expect different trajectories after subsequent disturbance.
As disturbance seemed to update communities toward more disturbance resistant ones [@Haddad2008] it is possible that eventually the disturbance regime observed has set another permanent condition, which would only be more diverse if good competitors, poor disturbance resitant survive.
We assume that such post-disturbance forest community might have the same functioning, as suggested by the functional trajectories, but composition displays a poor recovery, especially regarding species contingent to undisturbed forests or different life forms as lianas or epiphytes that have not been monitored here [@Martin2013].
Although forests functioning and processes seemed likely to recover after the range of disturbance studied, the hampered recovery of communities composition might jeopardize the conservation of some species, therefore threatening the global biodiversity [@Gardner2007].
Additionally to threats on particular species conservation the consequences of biodiversity changes on hyper-diverse ecosystems might reveal dramatic, specifically in impairing ecosystems resilience and resistance to further disturbance [@Trenbath1999;@Elmqvist2003;@Diaz2006].
...
-	To go beyond whole community diversity and highlight the ecological mechanisms behind communities assembly and repond to the question of their resilience we should focus on recruitment.
It would also refine the role of environmental filters shaping communities assembly.
