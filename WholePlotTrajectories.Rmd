...
## Validation of the IDH

The enhanced communities evenness and functional richness after disturbance confirmed the IDH for all treatment intensity.
...
Disturbance proved to favor species with acquisitive strategies, displaying efficient resource acquisition (high SLA) but short-lived tissues (low wood density, leaf toughness and thickness) and with a dispresive strategy (low seed mass) [@Westoby1998;@Wright2004;@Reich2014].
...
In particular, the evolution seed mass classes proportions revealed a clear increase in small seeded, therefore large dispersive, species [@TerSteege2001;@Flores2006;@Haddad2008].
