...
Plots functional diversity had recovered initial values for almost all plots 30 years after disturbance. 
It followed a hump-back trajectory that was mirror by all leaf, stem and life history traits, to the exception of leaf chlorophyll content.
This recovery of communities functional characteristics would go along the recovery of ecosystems processes [@Guariguata2001], as functional traits are the most direct link between biodiversity and ecosystem functioning [@Diaz2005].
Similar hump-back trajectories were followed by communities taxonomic and functional composition which argued for the convergence of communities composition maintaining the initial difference after the recovery cycle [@Hubbell1999;@Molino2001;@Baraloto2012a].
Besides, desipte a homogeneous trend among plots, the trajectories proved quite variable among plots, specifically after intense disturbance.
This meant a strong dependency of plots recovery time and trajectory to initial composition or abiotic conditions.
...
Composition trajectories, though, translated marked differences in communities composition as the functional diversity had already recovered.
Such delay between functional and taxonomic dynamics, already observed for grasslands [@Tilman1997; @Mouillot2011] and more recently for tropical forests [@Lohbeck2015;@Guariguata2001].
Assuming the "vegetation quantity effect", suggesting that communities functional characteristics are defined  by dominant species rather that subtle changes in biodiversity [@Grime1998], this delay meant a faster recovery of dominant species while this of infrequent ones would be much longer.
These infrequent species missing to plots taxonomic recovery would consequently be functionally redundant with those already in place.
