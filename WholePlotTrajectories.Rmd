...
The mechanisms under which disturbance shapes communities diversity and structure involve the foster of certain species either stochastically, through the recruitment and dispersal limitation [@Hubbell1999] or determinisitcally through the selection of suited ecological types.
Disturbance indeed in the context of old growth, stable forests where competitive exclusion favors best competitor species causes a shift toward disturbance resistant species with rapid growth and efficient resources acquisition [@Haddad2008].
This is illustrated by a shift from slow growth with scarce resources and high competitive ability, "conservative strategies", to fast growth with prolific resourcesn, "acquisitive strategies".
...
Beyond diversity indices it is essential to analyse changes in taxonomic composition so that the impact on species per se and their particular impact on ecosystem can be followed [@Lavorel2002;@Bellwood2006;@Baraloto2012a] along with the ecological rules shaping communities assembly and abundance distribution [@Magurran1988].
...
Consistently with dynamicspreviously observed in a Bornean rainforest [@Cannon1998] or in Solomon islands [@Burslem2000], the unimodal response of diversities to disturbance suggested the maintenance of diversity levels, although for one of the intensively disturbed plot the community evenness was still increasing \@ref(fig:Fig5). 
What contrasted in our study though is that taxonomic composition did clearly recover \@ref(fig:Fig3), which may imply a long-term, if not irreversible, change in communities after disturbance.


Regarding the functionl trajectories and dominnant trait values of disturbed communities \@ref(fig:Fig3), disturbance appeared to favor acquisitive strategies, *i.e* species with high SLA, low wood density, small seeds, etc [@Westoby1998;@Wright2004;@Reich2014].
...
Given the observed lack of composition recovery, in favor of more disturbance resistant species [@Haddad2008], the likely decrease in functional overlap, and the probable changes in different life like lianas or epiphytes [@Martin2013] and environmental conditions like soils nutrient cycling and compaction [@Olander2005], the entirety of communities recovery after intense disturbance is questioned.
In this case, post-disturbance communities might have the same functioning, as suggested by the observed functional recovery, but composition would be permanently altered in the case of most intense disturbance and species contingent to undisturbed forests in particular would be impaired.
This threatens the global biodiversity along with the risk to loose cornerstone species and trigger unexpected consequences [@Diaz2005;@Gardner2007].
