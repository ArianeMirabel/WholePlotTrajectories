...
This decoupling confirms the independence for tropical forests between the processes grasped through the studied functional traits (primary productivity, water and nutrient cycling, etc.) and communities composition and evenness as it was suggested .  
...
As disturbance seemed to update communities toward more disturbance resistant ones [@Haddad2008] it is possible that eventually the disturbance regie observed has set another permanent condition, which would only be more diverse if good competitors, poor disturbance resitant survive.
