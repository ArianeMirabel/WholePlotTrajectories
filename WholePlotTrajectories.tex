...
disturbance and clarify the link between biodiversity and sitruabnce is
urgent to anticipate the impact of the global change context. The
taxonomic and functional facets of tree communities trajectories
following disturbance and the underlying processes remain to be
clarified. The explicit impact of disturbance intensity, often
formalized with the Intermediate Disturbance Hypothesis (IDH), is
controversial as well in tropical forests. To clarify post-disturbance
trajectories and examine the scope of the IDH in tropical forests, we
analyzed tree community response to a disturbance gradient in a
Neotropical forest. We examined community diversity, composition and
redundancy trajectories over 30 years. We considered taxonomic and
functional trajectories, based on 7 leaf, stem and life-history traits.
We highlighted a decoupling between taxonomic trajectories, different
between communities, and functional trajectories that were identical,
which we explained by the variations in community functional redundancy.
We besides clarified the scope of the IDH, which did not apply to the
functional diversity but corroborated the hump-shaped taxonomic
diversity pattern. Although consistent, the recovery of community
