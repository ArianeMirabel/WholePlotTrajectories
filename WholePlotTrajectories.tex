...
Examine post-disturbance trajectories requires a set of diversity
metrics, to grasp all aspects of community changes
\citep{Sheil2003, Shea2004, Mayfield2010}. Specifically, diversity
metrics should assess taxonomic richness, evenness and composition, in
order to highlight the changes the community abundance distribution and
in the species fostered by the disturbance. Analysis would as well
include a functional approach accounting for species biological
attributes and ecological strategy. The trait-based approach directly
...
resilience, (ii) discussed the scope of the IDH and the underlying
ecological processes, and (iii) examined community recovery time.
