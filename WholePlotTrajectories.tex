...
\citep{Schnitzer2001, Anderson-Teixeira2013, Sist2015}, so anticipate
the fate of tropical forests requires to understand community response
to disturbance. Disturbance initiate ecological succession comprising a
suit of changes in community structure and functioning over time, which
rate, endpoint an duration depend on the disturbance intensity
\citep{Chazdon2003, Willig2018}. Regarding tropical forests, community
response to disturbance would be secondary succession, starting with an
intact soil and a consistent seed bank, from which we aim would be to
highlight predictable trajectories and their underlying ecological
processes.
...
\citep{Goulamoussene2017}, and modifications in species interactions,
mainly through modifications of species density \citep{Chesson2000}. For
now, post-disturbance response has been largely studied through forest
structural parameters, rapid and convenient to measure, such as
aboveground biomass, tree height or stem density
\citep{Piponiot2016, Rutishauser2016}. Thereafter, models based on the
observed trajectories after disturbance gave important insights into
community recovery and resilience \citep{Herault2018}. Regarding
community diversity and composition, however, post-disturbance
trajectories have not been as thoroughly understood. A leading idea on
how the impacts of disturbance on community diversity is the
Intermediate Disturbance Hypothesis (IDH) \citep{Connell1978}. The IDH
assumes biodiversity changes in relation to disturbance intensity and
frequency, with diversity peaks for intermediate intensity and at
intermediate time after disturbance. At intermediate level of
disturbance, the fluctuation of environmental conditions entails
deterministic processes favoring both competitively superior species and
fast colonizers, hence preventing competitive exclusion
\citep{Shea2004, Pulsford2016}.

The IDH then assumes both predictable trajectories depending on the
disturbance intensity, and, without additional disturbance, the recovery
of pre-disturbance state defined by the dominance of late-successional
species \citep{Rees2001, Sheil2003, Willig2018}. In highly diverse
tropical forests, however, empirical validation of the IDH remains
debated \citep{Fox2013, Sheil2013} and observed post-disturbance
trajectories are often blurry compared to theoretical expectations
\citep{Hugues2007}.

Still, empirical evidence often relied on the analysis of a single
diversity metric, often the taxonomic richness \citep{Molino2001}, and
this might give limited or misleading information on forests recovery
and functioning. More ecological-meaningful analysis would first couple
taxonomic richness and evenness, which reveals the changes in species
abundance distribution and hence in the underlying ecological processes
\citep{Chaudhary2016}. Analysis would as well include taxonomic
composition, which is crucial for conservation issues
\citep{Lavorel2002, Bellwood2006}. Eventually, including a functional
approach accounting for species biological attributes would be highly
revealing of ecological process involved in community response to
disturbance. The functional trait-based approach indeed directly links
community diversity, composition and redundancy to ecosystem functioning
and environmental constraints \citep{Violle2007b, Baraloto2012a}. In
that respect, a vast literature allowed recognizing major traits related
to species ecology and mediating species performance in a given
environment \citep{Diaz2005}. Specifically in tropical forests, the
...
translated into the trajectories of average community value of key
functional traits related to resource acquisition (leaf and stem traits)
and life-history strategy (seed mass, maximum size)
\citep{Wright2004, Diaz2005, TerSteege2006, Westoby2006a, Chave2009b}.
The functional approach would eventually be completed with the analysis
of functional redundancy that quantifies the amount of shared trait
values among species \citep{Carmona2016}. The high functional redundancy
of hyper-diverse tropical forests \citep{Bellwood2006} mitigates the
...
\citet{Rees2001}{]}. Yet, observed trajectories proved to often deviate
from predictions and from the recovery of initial state and thus
evidenced the interplay of stochastic processes
\citep{Hubbel2001, Norden2015, Norden2017}. The debate underlying the
study of community response to disturbance is now on the relative
importance of stochastic and deterministic processes, and on the nature
of ecological rules and mechanisms they generate.

Specifically, the determinism of post-disturbance trajectories is the
base of the intermediate disturbance hypothesis (IDH) which is assumed
to be a determinant of tropical forest biodiversity \citep{Connell1978}.
...
Community taxonomic richness and evenness trajectories both proved to
depend on the intensity of disturbance and to markedly change above an
intensity threshold, thus supporting the IDH. The disturbance intensity
determined the balance in the community between pre-disturbance
surviving trees, and trees recruited afterward. Below an intensity of
20\%-25\% AGB loss, the trees surviving after disturbance remained
numerous enough to maintain the high taxonomic richness of the
pre-disturbance community. The recruitment of pionners, infrequent or
absent before disturbance, then increased the community taxonomic
richness positively correlated with the disturbance intensity
\citep{Martin2015, Chaudhary2016}. Besides, the pioneers became
increasingly dominant and temporarily balanced the usual hyper-dominance
of a few species \citep{Baraloto2012a}. The taxonomic evenness then
followed hump-shaped trajectoriesas already observed in the Guiana
shield \citep{Baraloto2012a} and in Borenan tropical forests
\citep{Cannon1998}, with first an increase positively correlated to the
disturbance intensity, and then an return towards initial values. Above
the intensity threshold, the taxonomic richness of surviving trees was
...
trajectories following intense disturbance then decreased, all the more
so that the disturbance intensity was high \citep{Molino2001}. At the
...
shade-tolerant species. The intensity threshold then marked two distinct
post-disturbance trajectories, and a change in community response to
disturbance. In accordance with the IDH, an intense disturbance below
the intensity threshold would then maximise community richness and
evenness. Such intermediate disturbance would increase the availability
of resources, creating opportunities for pioneers, while allowing a high
diversity among surviving trees and the maintenance of shade-tolerant
species \citep{Bongers2009}.

Regarding community functional response in contrast, the IDH seemed
disproved. Whenever the disturbance intensity, both community functional
richness and evenness increased, with the recruitment of pioneers that
were functionally highly different from the species of the
...
The IDH then translated into community post-disturbance taxonomic
trajectories, with marked differences below and above an intensity
threshold. It was however not tangible regarding the functional
trajectories, because of their decoupling with taxonomic trajectories.
...
In accordance with the IDH, community taxonomic diversity was maximise
