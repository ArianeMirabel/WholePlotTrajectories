...
{\centering \includegraphics[width=1\linewidth]{WholePlotTrajectories_files/figure-latex/Fig6-1} 
...
Plots functional diversity had recovered initial values for almost all
plots 30 years after disturbance. It followed a hump-back trajectory
that was mirror by all leaf, stem and life history traits, to the
exception of leaf chlorophyll content. This recovery of communities
functional characteristics would go along the recovery of ecosystems
processes \citep{Guariguata2001}, as functional traits are the most
direct link between biodiversity and ecosystem functioning
\citep{Diaz2005}. Similar hump-back trajectories were followed by
communities taxonomic and functional composition which argued for the
convergence of communities composition maintaining the initial
difference after the recovery cycle
\citep{Hubbell1999, Molino2001, Baraloto2012a}. Besides, desipte a
homogeneous trend among plots, the trajectories proved quite variable
among plots, specifically after intense disturbance. This meant a strong
dependency of plots recovery time and trajectory to initial composition
or abiotic conditions.

\section{The comparison of observed trajectories to a null model with
random traits set shuffling showed an oriented functional shift after
disturbance which suggest additional biotic and abiotic filters for the
10 to 15 years after
disturbance.}\label{the-comparison-of-observed-trajectories-to-a-null-model-with-random-traits-set-shuffling-showed-an-oriented-functional-shift-after-disturbance-which-suggest-additional-biotic-and-abiotic-filters-for-the-10-to-15-years-after-disturbance.}

\section{This means a shift from exclusive competition favoring
competitive species before disturbance to environmental filtering
selecting acquisitive and disturbance resistant
species.}\label{this-means-a-shift-from-exclusive-competition-favoring-competitive-species-before-disturbance-to-environmental-filtering-selecting-acquisitive-and-disturbance-resistant-species.}

\subsection{Functional redundancy of disturbed
ecosystems}\label{functional-redundancy-of-disturbed-ecosystems}

Composition trajectories, though, translated marked differences in
communities composition as the functional diversity had already
recovered. Such delay between functional and taxonomic dynamics, already
...
Assuming the ``vegetation quantity effect'', suggesting that communities
functional characteristics are defined by dominant species rather that
subtle changes in biodiversity \citep{Grime1998}, this delay meant a
faster recovery of dominant species while this of infrequent ones would
be much longer. These infrequent species missing to plots taxonomic
recovery would consequently be functionally redundant with those already
in place. The functional overlap between species, typical of the huge
biodiversity of tropical forests \citep{Bellwood2006}, is then not
