...
tropical forests, however, the validation of the IDH remains
controversial \citep{Fox2013, Sheil2013} and observed post-disturbance
trajectories are often blurry compared to theoretical expectations
\citep{Hugues2007}. Empirical evidence generally rely on the analysis of
a single diversity metric, often the taxonomic richness
\citep{Molino2001}, which might give limited or misleading information
on community disturbance response. The IDH pattern of diversity peak
under an intermediate disturbance regime can indeed result from various
ecological processes \citep{Sheil2003}. To disentangle these various
processes and grasp the different facets of community response to
disturbance it is crucial to combine a suitable range of approaches
\citep{Shea2004}. More ecological-meaningful analysis would first couple
