...
\Abstract{
Understanding biodiversity trajectories of tropical forests following
disturbance and clarifying the link between biodiversity and disturbance
is urgent to anticipate the impact of the global change context. This
calls to highlight the taxonomic and functional facets of tree community
...
Intermediate Disturbance Hypothesis (IDH) that is debated in tropical
forests. In this study, we analyzed the tree community response to a
...
class decreased while it stabilized for the two other (Supp. Mat. - Fig.
S2).
...
by a displacement to the right along the first axis in the functional
plane \citep{Westoby1998, Wright2004, Reich2014}. Thereafter, the
...
translated in the functional plane by a displacement left along the
