...
This context specifically threatens the maintenance of community
structure, composition and functioning \citep{Anderson-Teixeira2013}. In
tropical forests indeed, tree communities biodiversity and composition
rely on a natural disturbance regime, specifically through tree fall
gaps \citep{Schnitzer2001}. This disturbance regime is affected by the
current changing context and anthropic activities \citep{Sist2015}, so
clarify community response to disturbance and the underlying ecological
processes is crucial to anticipate the fate of tropical forests
\citep{Chazdon2003}.
...
mainly through the reduction of species density \citep{Chesson2000}. For
now, community response to disturbance has been largely studied through
forest structural parameters, rapid and convenient to measure, such as
...
how disturbance affect community diversity is the Intermediate
Disturbance Hypothesis (IDH) \citep{Connell1978} predicting biodiversity
peaks at intermediate value of disturbance intensity and at intermediate
time after disturbance. The IDH is founded on the emergence after
disturbance of deterministic processes that prevent competitive
exclusion through the fluctuations of dominant competitors along time
due to disturbance environmental impacts \citep{Fox2013}. The IDH
assumes predictable post-disturbance trajectories depending on the
intensity of disturbance, that define the importance of disturbance
impacts \citep{Willig2018}. It also assumes, without additional
disturbance, a recovery of the pre-disturbance state defined by the
dominance of late-successional species
\citep{Rees2001, Carreno-Rocabado2012, Poorter2016}. In highly diverse
