...
\citep{Morales-Hidalgo2015}. This growing pressure affects the natural
disturbance regime that shape and maintain the structure, composition
and functioning of tree communities
\citep{Schnitzer2001, Anderson-Teixeira2013, Sist2015}. It is then
urgent to understand the processes underlying community response to
disturbance in order to anticipate the fate of tropical forests in the
current context. In tropical forests, disturbance maintains a forest
environment and is followed by secondary succession comprising a suit of
changes in the structure and functioning of communities. Disturbance
change both community abiotic and biotic environments, through
...
the determinants of post-disturbance trajectories, as forest structure,
forest composition, environmental parameters and disturbance
...
thoroughly understood \citep{Guitet2018, Molino2001}. Biodiversity
trajectories result from the differences in species response to
disturbance which entail a variety of processes like colonisation,
facilitation, coexistence \citep{Lindenmayer2012, Garcia_florez2017}.
The rate, endpoint and duration of post-disturbance trajectories depend
on the intensity and frequency of disturbance: a current objective of
tropical ecology is to highlight this linkage betwenn biodiversity and
disturbance, and anticipate community response
...
community diversity peaks at intermediate level of disturbance. The
fluctuations of environmental conditions after disturbance are assumed
to prevent competitive exclusion as they foster both competitively
superior species and fast colonizers \citep{Shea2004, Pulsford2016}. In
highly diverse tropical forests, however, observations of the IDH are
often blurry compared to theoretical expectations
\citep{Hugues2007, Sheil2003, Norden2017} the validation of the theory
remains controversial \citep{Hubbell2001, Fox2013, Sheil2013}. As
previously highlighted, there is a variety of ecological processes
emerging after disturbance, and the pattern of the IDH (the diversity
peak under intermediate disturbance) can result from various processes.
Disentangle these processes in the context of tropical forests would
assess the conditions for the IDH application and clarify the
disturbance impact on communit diversity \citep{Sheil2003, Shea2004}.
