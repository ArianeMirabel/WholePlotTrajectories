...
sucessfully modeled, giving important insights into the recovery of
...
Figure \ref{fig:NMDSplans} \citep{Westoby1998, Wright2004, Reich2014}.
...
second axis in Figure \ref{fig:NMDSplans}.
...
increasingly slow, so that the time for the full recovery of the
functional redundancy, in some communities just initiated after 30
years, was extremely difficult to estimate
