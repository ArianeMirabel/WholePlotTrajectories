...
was reported using the functional richness and evenness, \emph{i.e} Rao
index of quadratic entropy which combines species abundance distribution
and average pairwise dissimilarity based on species functional traits.
...
richness and evenness trajectories depended on the disturbance intensity
with their maximum positively correlated to \%AGB loss
...
up to maximum reached after 20-25 years and, and for high intensity, a
...
along the disturbance intensity gradient \ref{fig:IDHplot}. Along the
disturbance intensity gradient the disturbance impact was more markedly
hump-shaped for the taxonomic richness than for the taxonomic evenness
and the functional diversity, the latest being almost linear. The
regression model better predicted the functional richness and evenness
...
Disturbance appeared to enhance community taxonomic richness until an
...
disturbance impact on community taxonomic richness and to some extent on
taxonomic evenness. The disturbance intensity determines the balance in
the community between pre-disturbance surviving trees and the trees
recruited afterward. In the Guiana Shield, the pool of true pioneer
species specifically recruited after disturbance is restricted to a few
common genera (e.g.~Cecropia spp., Vismia spp.). Below the intensity
threshold the size of the surviving community maintains its
pre-disturbance taxonomic richness and the recruitment of pioneers,
infrequent or absent before disturbance, increases both community
taxonomic richness and evenness. Beyond the intensity threshold the
taxonomic diversity of the surviving trees decreases and is not offset
by the taxonomic enrichment of pioneers. The disturbance impact was
similar but slighter for community taxonomic evenness, that is less
sensitive to the loss of rare species and rather represents the
increased dominance of pionneers that balanced the usual hyper-dominance
of tropical forest. While below the intensity threshold pioneers species
increase the diversity of dominant or common species, beyond the
threshold they become in turn highly dominant.

Conversely the IDH was disproved to predict the dsiturbance impact on
community functional diversity. Pioneer species were functionally highly
different from the pre-disturbance community composition, so their
recruitment increased the community functional richness and eveness
whenever its intensity.

Along time, the post-disturbance taxonomic richness trajectories showed
first a similar drop following the species loss during disturbance, and
then a species gain determined by the disturbance intensity. Until an
intensity threshold the gain in taxonomic richness increased with the
disturbance intensity through the establishment of long-lived pioneers
enhancing community taxonomic richness and evenness in the long term.
These long-lived pionneers were functionally quite different from the
functional composition and their establishment entailed a progressive
and long-lasting increase of the functional diversity. Beyond the
intensity threshold a few short-lived pioneers occupied the vacated
environmental space and prevented further species establishment. These
short-lived pioneers were functionally very different from the
pre-disturbance community and rapidly and significantly increased the
functional diversity. Already after 10 years, though, they started to
decline and the functional diversity started to decrease. Likely the
establishment of long-lasting pioneers will follow and we expect the
taxonomic and functional trajectories to catch up with those observed
after intermediate disturbance.

\subsection{The functional redundancy, key of the community
resilience}\label{the-functional-redundancy-key-of-the-community-resilience}
...
redundancy within the pre-disturbance functional space. At first place
the pioneers recruited, functionally different from the pre-disturbance
functional composition did not compensate for the reundancy decrease.
Progressively though, first establish species were replaced by more
competitive long-lived pionneers or late-successional species resembling
more the pre-disturbance functional composition and restoring the
functional redundancy. This replacement was stochastic and followed the
lottery recruitment rules, that ease the recovery for the first
recruited species but then increasingly hamper it with the emergence of
interspecific competition due to increasing functional redundancy
\citep{Busing2002}. Along time the recovery of infrequent species is
increasingly difficult, and the recovery of the functional redundancy
that was just initiated after 30 years in some communities is difficult
to estimate \citep{Trenbath1999, Elmqvist2003, Diaz2005}.
