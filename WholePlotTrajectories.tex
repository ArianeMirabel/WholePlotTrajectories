...
\citep{Rejou2017}. The three treatments constituted a disturbance
...
functional evenness, \emph{i.e} the Rao index of quadratic entropy. The
Rao index combines species abundance distribution, and the average
pairwise functional dissimilarity between species computed by the gower
distance.
...
trajectories. While initial differences in community taxonomic
composition were maintained after disturbance, their trajectories in
functional composition were similar. In parallel, while the different
taxonomic diversity trajectories displayed marked differences according
to the disturbance intensity, the functional diversity trajectories were
homogeneous whenever the disturbance intensity. This decoupling was
accompanied by a decrease in community functional redundancy which
appeared to be the key element of community post-disturbance recovery.
...
recruitment of a group of pioneers, as \emph{Cecropia} spp.,
\emph{Vismia} spp., common to all communities whenever their initial
differences and the intensity of disturbance
...
Comparing community diversity along time after disturbance revealed
constrasting trajectories according to the distrubance intensity. Below
a disturbance intensity threshold, in the case of treatments 1 and 2,
the community taxonomic richness increased. In parallell, after a first
increase, the taxonomic eveness stabilized or strated to decrease after
30 years. Below the intensity threshold Contrastingly, above an
intensity threshold, in the case of treatment 3, the taxonomic richness
did not exceeded the initial value and the taxonomic evenness
continiously increased for 30 years without sign of return towards the
initial value. Below and above a threshold, corresponding to a
disturbance intensity between treatments 2 and 3, community taxonomic
richness and evenness changed markedly. A the disturbance intensity
threshold, the taxonomic richness was maximized and the taxonomic
evenness remained resilient. The disturbance intensity impacted the
balance in the community between pre-disturbance surviving trees, and
trees recruited afterward. On the one hand, below a 20\%-25\% AGB loss,
the trees surviving after disturbance remained numerous enough to
maintain the high taxonomic richness of the pre-disturbance community
...
accompanied by a decrease in the functional redundancy within the
pre-disturbance functional space. This decrease was explained by a loss
of species following disturbance and then a lower redundancy of their
functional characteristics. This decrease of the functional redundancy
was not compensated by the recruitment of pioneers, as those were
functionally different from the pre-disturbance community. Progressively
though, more competitive,long-lived pioneers or late-successional
species functionally closer to the pre-disturbance community
progressively replaced the first established species and restored the
functional redundancy. This replacement followed the lottery recruitment
rules, implying an easy recruitment for the first species but becoming
increasingly hampered by the emergence of interspecific competition
\citep{Busing2002}. The recovery of the functional redundancy then
relied upon the random process of species recruitment and was
...
were maintained along time. Community high functional redundancy could
explain this decoupling as the loss of a species does not necessarily
the loss of its functional charactristics in the community. In this
sense, the functional redundancy would mitigate the functional impact of
disturbance. Community functional and taxonomic diversity response to
disturbance were contrasted as well. While the functional trajectories
...
\citep{Herault2018}. Our conclusions first highlighted risks to lose
rare species with visible impacts only in the long term, and led us to
advice paying particular attention to rare and undangered species and to
conduct regular inventories during exploitation times. Second,
post-disturbance trajectories seemed to greatly rely on post-disturbance
recruitment dynamics that would be key to model post-disturbance
trajectories.
