...
besides analysed through the linear correlations between (i) taxonomic
and functional richness, evenness and diversity and (ii) the initial
\%AGB removed at 10, 20 and 30 years after disturbance.
...
for te taxonomic richness (\(-0.09<R^2<-0.06\)), for the taxonomic
evenness (\(R^2<0.25\)) while highly significant for functional
diversity (\(0.60<R^2<0.75\)) whatever the time since disturbance.
