...
\textbf{Figure S2}: Scheme of the redundancy measurement process
...
\section{\texorpdfstring{\textbf{Figure S1}: Bayesian process
sheme}{Figure S1: Bayesian process sheme}}\label{figure-s1-bayesian-process-sheme}
...
\section{\texorpdfstring{\textbf{Figure S2}: Redundancy
metric}{Figure S2: Redundancy metric}}\label{figure-s2-redundancy-metric}
...
\section{\texorpdfstring{\textbf{Figure S3}: Proportion of seed mass
classes along
time}{Figure S3: Proportion of seed mass classes along time}}\label{figure-s3-proportion-of-seed-mass-classes-along-time}
