...
taxonomic composition trajectories, that differed among communities, and
functional trajectories, that remained similar and convergent. The
taxonomic diversity followed humped-shaped trajectories depending on the
disturbance intensity that validated the IDH (Intermediate Disturbance
Hypothesis), while functional diversity trajectories homogeneous among
all plots dismissed the IDH. We explained this decoupling by the
variations in community functional redundancy that mitigates the
